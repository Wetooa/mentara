...
export type UpdateTherapistStatusDto = z.infer<
  typeof UpdateTherapistStatusDtoSchema
>;
export type PendingTherapistFiltersDto = z.infer<
  typeof PendingTherapistFiltersDtoSchema
>;
export type AdminAnalyticsQuery = z.infer<typeof AdminAnalyticsQuerySchema>;
export type AdminUserListParamsDto = z.infer<
  typeof AdminUserListParamsDtoSchema
>;
export type AdminUserGrowthParamsDto = z.infer<
  typeof AdminUserGrowthParamsDtoSchema
>;
export type AdminEngagementParamsDto = z.infer<
  typeof AdminEngagementParamsDtoSchema
>;
export type AdminModerationReportParamsDto = z.infer<
  typeof AdminModerationReportParamsDtoSchema
>;
export type AdminTherapistApplicationParamsDto = z.infer<
  typeof AdminTherapistApplicationParamsDtoSchema
>;
export type AdminTherapistApplicationFiltersDto = z.infer<
  typeof AdminTherapistApplicationFiltersDtoSchema
>;
export type AdminMatchingPerformanceParamsDto = z.infer<
  typeof AdminMatchingPerformanceParamsDtoSchema
>;
export type AdminFlaggedContentParamsDto = z.infer<
...
export type UpdateModerationReportRequest = z.infer<
  typeof UpdateModerationReportRequestSchema
>;
...
export const TherapistApplicationDetailsResponseSchema = z.object({
...
export const TherapistActionResponseSchema = z.object({
  success: z.boolean(),
  message: z.string(),
  therapist: z.object({
    userId: z.string(),
...
export const TherapistApplicationMetricsResponseSchema = z.object({
  period: z.object({
    start: z.date(),
    end: z.date(),
  }),
  summary: z.object({
    ...
    processedApplications: z.number(),
  }),
  metrics: z.object({
    approvalRate: z.number(),
    averageProcessingTimeDays: z.number(),
    applicationTrend: z.enum(['increasing', 'decreasing', 'stable']),
  }),
...
export const TherapistListResponseSchema = z.object({
  applications: z.array(z.any()), // Complex nested structure with therapist + user data
  summary: z.object({
  ...
  filters: z.any(), // The filters object passed in
});
