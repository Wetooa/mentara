...
const AUDIT = {
    ...
    description: "The Alcohol Use Disorders Identification Test (AUDIT) is a 10-item screening tool developed by the World Health Organization (WHO) to assess alcohol consumption, drinking behaviors, and alcohol-related problems. A score of 8 or more is considered to indicate hazardous or harmful alcohol use.",
    questions: [
        {
            prefix: "Frequency",
    ...
    disclaimer: "This questionnaire is a screening tool to assess alcohol use disorder risk. It does not serve as a diagnostic tool and should be followed by a clinical evaluation. If you have concerns about your alcohol consumption, please consult a healthcare professional.",
};
