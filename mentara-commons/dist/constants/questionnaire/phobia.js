...
const PHQ = {
    ...
    description: "The PHQ is a self-administered questionnaire used to assess the extent to which individuals avoid specific situations due to fear or other unpleasant feelings. It is commonly used for diagnosing and monitoring phobic symptoms.",
    questions: [
        {
            prefix: "",
    ...
    disclaimer: "This questionnaire is a screening tool to assess the severity of phobic symptoms. It does not serve as a diagnostic tool and should be followed by a clinical evaluation. If you have concerns about your mental health, please consult a healthcare professional.",
};
exports.default = PHQ;
//# sourceMappingURL=phobia.js.map