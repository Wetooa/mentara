  ...
  const sendMessageMutation = useMutation({
    ...
    onMutate: async ({ conversationId, messageData }) => {
      ...
      const tempMessage: MessagingMessage = {
        id: `temp-${Date.now()}`,
        authorId: user?.id || "", // Fixed: use authorId instead of senderId
        content: messageData.content,
        type: messageData.type || "text", // Fixed: use lowercase type
        conversationId,
        ...
        isEdited: false,
        isDeleted: false,
        replyToMessageId: messageData.replyToMessageId, // Fixed: use replyToMessageId
        attachments: [],
        reactions: [],
        readReceipts: [],
      };
  ...
  const sendMessage = useCallback(
    (
      ...
      const messageData: SendMessageDto = {
        content,
        type: options?.type || "text", // Fixed: use lowercase type
        replyToMessageId: options?.replyToMessageId, // Fixed: use replyToMessageId
