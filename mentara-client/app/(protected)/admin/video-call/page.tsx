    ...
    return (
      <div className="h-screen w-full bg-gray-900 flex items-center justify-center">
        <Card className="w-96 bg-gray-800 border-gray-700">
          ...
          <CardContent className="space-y-4">
            <div className="text-center">
              <Badge variant="outline" className="mb-3 border-red-600 text-red-400">
                <Shield className="h-3 w-3 mr-1" />
                Administrative Call
              </Badge>
            </div>
  ...
  if (callState.status === 'in_call' && callState.remoteUserInfo) {
    return (
      <div className="relative">
        {/* Admin-specific overlay */}
        <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-20">
          <Card className="bg-black/60 border-red-600">
            <CardContent className="p-2">
              <div className="flex items-center space-x-2 text-sm">
                <Shield className="h-4 w-4 text-red-400" />
                <span className="text-white">Administrative Call</span>
