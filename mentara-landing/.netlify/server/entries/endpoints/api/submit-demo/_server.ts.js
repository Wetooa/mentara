...
const EMAILJS_SERVICE_ID = private_env.EMAILJS_SERVICE_ID || "";
const EMAILJS_TEMPLATE_ID = private_env.EMAILJS_TEMPLATE_ID || "";
const EMAILJS_PUBLIC_KEY = private_env.EMAILJS_PUBLIC_KEY || "";
const EMAILJS_PRIVATE_KEY = private_env.EMAILJS_PRIVATE_KEY || "";
const IS_DEBUG = private_env.NODE_ENV === "development";
const POST = async ({ request }) => {
  try {
    ...
    const templateParams = {
      ...
      submittedAt: (/* @__PURE__ */ new Date()).toLocaleString("en-US", {
        weekday: "long",
        year: "numeric",
        month: "long",
        day: "numeric",
                ...
                <tr>
                  <td style="text-align: center;">
                    <p style="margin: 0 0 8px 0; color: #6B7280; font-size: 13px;">
                      <strong style="color: #6B9900;">⏰ Submitted:</strong> ${(/* @__PURE__ */ new Date()).toLocaleString(
        "en-US",
        {
          weekday: "long",
          year: "numeric",
