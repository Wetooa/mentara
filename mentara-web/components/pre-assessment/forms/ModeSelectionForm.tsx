        ...
        <div className="flex flex-col gap-4">
          ...
          >
            ...
            <p className="text-xs text-black/60 text-left">
              Our AI will guide you through the assessment by asking questions in a natural conversation. 
              You can answer in your own words, and the AI will help extract the information needed.
            </p>
          </button>
          ...
          >
            <div className="flex items-center gap-3 w-full">
              ...
              <div className="flex-1 text-left">
                <h5 className="font-semibold text-base">Traditional Checklist</h5>
                <p className="text-sm text-muted-foreground mt-1">
