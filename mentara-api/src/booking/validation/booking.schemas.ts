...
const MeetingCreateDtoSchema = z.object({
...
const MeetingUpdateDtoSchema = z.object({
...
const TherapistAvailabilityCreateDtoSchema = z.object({
...
const TherapistAvailabilityUpdateDtoSchema = z.object({
