...
export const RoomGroupUpdateArgsSchema: z.ZodType<Prisma.RoomGroupUpdateArgs> = z.object({
  select: RoomGroupSelectSchema.optional(),
  include: z.lazy(() => RoomGroupIncludeSchema).optional(),
  data: z.union([ RoomGroupUpdateInputSchema,RoomGroupUncheckedUpdateInputSchema ]),
  where: RoomGroupWhereUniqueInputSchema,
}).strict() ;

export default RoomGroupUpdateArgsSchema;
