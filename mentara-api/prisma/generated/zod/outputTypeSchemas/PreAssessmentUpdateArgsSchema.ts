...
export const PreAssessmentUpdateArgsSchema: z.ZodType<Prisma.PreAssessmentUpdateArgs> = z.object({
  select: PreAssessmentSelectSchema.optional(),
  include: z.lazy(() => PreAssessmentIncludeSchema).optional(),
  data: z.union([ PreAssessmentUpdateInputSchema,PreAssessmentUncheckedUpdateInputSchema ]),
  where: PreAssessmentWhereUniqueInputSchema,
}).strict() ;

export default PreAssessmentUpdateArgsSchema;
