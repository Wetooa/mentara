...
import { ModeratorCreateInputSchema } from '../inputTypeSchemas/ModeratorCreateInputSchema'
import { ModeratorUncheckedCreateInputSchema } from '../inputTypeSchemas/ModeratorUncheckedCreateInputSchema'
...
export const ModeratorUpsertArgsSchema: z.ZodType<Prisma.ModeratorUpsertArgs> = z.object({
  select: ModeratorSelectSchema.optional(),
  include: z.lazy(() => ModeratorIncludeSchema).optional(),
  where: ModeratorWhereUniqueInputSchema,
  create: z.union([ ModeratorCreateInputSchema,ModeratorUncheckedCreateInputSchema ]),
  update: z.union([ ModeratorUpdateInputSchema,ModeratorUncheckedUpdateInputSchema ]),
}).strict() ;

export default ModeratorUpsertArgsSchema;
