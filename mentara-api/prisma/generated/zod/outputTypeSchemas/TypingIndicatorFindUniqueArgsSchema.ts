...
export const TypingIndicatorFindUniqueArgsSchema: z.ZodType<Prisma.TypingIndicatorFindUniqueArgs> = z.object({
  select: TypingIndicatorSelectSchema.optional(),
  where: TypingIndicatorWhereUniqueInputSchema,
}).strict() ;

export default TypingIndicatorFindUniqueArgsSchema;
