...
export const ModeratorCommunityUpdateArgsSchema: z.ZodType<Prisma.ModeratorCommunityUpdateArgs> = z.object({
  select: ModeratorCommunitySelectSchema.optional(),
  include: z.lazy(() => ModeratorCommunityIncludeSchema).optional(),
  data: z.union([ ModeratorCommunityUpdateInputSchema,ModeratorCommunityUncheckedUpdateInputSchema ]),
  where: ModeratorCommunityWhereUniqueInputSchema,
}).strict() ;

export default ModeratorCommunityUpdateArgsSchema;
