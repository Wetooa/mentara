...
export const ClientPreferenceCreateManyArgsSchema: z.ZodType<Prisma.ClientPreferenceCreateManyArgs> = z.object({
  data: z.union([ ClientPreferenceCreateManyInputSchema,ClientPreferenceCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict() ;

export default ClientPreferenceCreateManyArgsSchema;
