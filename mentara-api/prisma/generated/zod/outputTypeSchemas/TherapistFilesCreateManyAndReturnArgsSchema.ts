...
export const TherapistFilesCreateManyAndReturnArgsSchema: z.ZodType<Prisma.TherapistFilesCreateManyAndReturnArgs> = z.object({
  data: z.union([ TherapistFilesCreateManyInputSchema,TherapistFilesCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict() ;

export default TherapistFilesCreateManyAndReturnArgsSchema;
