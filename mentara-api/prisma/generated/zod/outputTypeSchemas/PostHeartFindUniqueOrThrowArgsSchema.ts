...
export const PostHeartFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.PostHeartFindUniqueOrThrowArgs> = z.object({
  select: PostHeartSelectSchema.optional(),
  include: z.lazy(() => PostHeartIncludeSchema).optional(),
  where: PostHeartWhereUniqueInputSchema,
}).strict() ;

export default PostHeartFindUniqueOrThrowArgsSchema;
