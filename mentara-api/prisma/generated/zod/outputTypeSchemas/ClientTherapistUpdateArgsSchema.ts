...
export const ClientTherapistUpdateArgsSchema: z.ZodType<Prisma.ClientTherapistUpdateArgs> = z.object({
  select: ClientTherapistSelectSchema.optional(),
  include: z.lazy(() => ClientTherapistIncludeSchema).optional(),
  data: z.union([ ClientTherapistUpdateInputSchema,ClientTherapistUncheckedUpdateInputSchema ]),
  where: ClientTherapistWhereUniqueInputSchema,
}).strict() ;

export default ClientTherapistUpdateArgsSchema;
