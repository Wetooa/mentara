...
export const PreAssessmentCreateArgsSchema: z.ZodType<Prisma.PreAssessmentCreateArgs> = z.object({
  select: PreAssessmentSelectSchema.optional(),
  include: z.lazy(() => PreAssessmentIncludeSchema).optional(),
  data: z.union([ PreAssessmentCreateInputSchema,PreAssessmentUncheckedCreateInputSchema ]),
}).strict() ;

export default PreAssessmentCreateArgsSchema;
