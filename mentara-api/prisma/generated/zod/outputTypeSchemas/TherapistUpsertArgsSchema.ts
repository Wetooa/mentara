...
export const TherapistUpsertArgsSchema: z.ZodType<Prisma.TherapistUpsertArgs> = z.object({
  select: TherapistSelectSchema.optional(),
  include: z.lazy(() => TherapistIncludeSchema).optional(),
  where: TherapistWhereUniqueInputSchema,
  create: z.union([ TherapistCreateInputSchema,TherapistUncheckedCreateInputSchema ]),
  update: z.union([ TherapistUpdateInputSchema,TherapistUncheckedUpdateInputSchema ]),
}).strict() ;

export default TherapistUpsertArgsSchema;
