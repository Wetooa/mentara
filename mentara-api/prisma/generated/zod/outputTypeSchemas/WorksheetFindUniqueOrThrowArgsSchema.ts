...
export const WorksheetFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.WorksheetFindUniqueOrThrowArgs> = z.object({
  select: WorksheetSelectSchema.optional(),
  include: z.lazy(() => WorksheetIncludeSchema).optional(),
  where: WorksheetWhereUniqueInputSchema,
}).strict() ;

export default WorksheetFindUniqueOrThrowArgsSchema;
