...
export const ModeratorCreateArgsSchema: z.ZodType<Prisma.ModeratorCreateArgs> = z.object({
  select: ModeratorSelectSchema.optional(),
  include: z.lazy(() => ModeratorIncludeSchema).optional(),
  data: z.union([ ModeratorCreateInputSchema,ModeratorUncheckedCreateInputSchema ]),
}).strict() ;

export default ModeratorCreateArgsSchema;
