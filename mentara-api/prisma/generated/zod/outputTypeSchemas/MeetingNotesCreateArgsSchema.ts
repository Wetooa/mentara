...
export const MeetingNotesCreateArgsSchema: z.ZodType<Prisma.MeetingNotesCreateArgs> = z.object({
  select: MeetingNotesSelectSchema.optional(),
  include: z.lazy(() => MeetingNotesIncludeSchema).optional(),
  data: z.union([ MeetingNotesCreateInputSchema,MeetingNotesUncheckedCreateInputSchema ]),
}).strict() ;

export default MeetingNotesCreateArgsSchema;
