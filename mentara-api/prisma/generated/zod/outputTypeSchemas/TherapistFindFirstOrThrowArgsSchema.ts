...
export const TherapistFindFirstOrThrowArgsSchema: z.ZodType<Prisma.TherapistFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ TherapistScalarFieldEnumSchema,TherapistScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default TherapistFindFirstOrThrowArgsSchema;
