...
export const PostFileFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.PostFileFindUniqueOrThrowArgs> = z.object({
  select: PostFileSelectSchema.optional(),
  include: z.lazy(() => PostFileIncludeSchema).optional(),
  where: PostFileWhereUniqueInputSchema,
}).strict() ;

export default PostFileFindUniqueOrThrowArgsSchema;
