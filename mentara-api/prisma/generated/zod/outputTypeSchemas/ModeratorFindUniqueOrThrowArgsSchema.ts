...
export const ModeratorFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.ModeratorFindUniqueOrThrowArgs> = z.object({
  select: ModeratorSelectSchema.optional(),
  include: z.lazy(() => ModeratorIncludeSchema).optional(),
  where: ModeratorWhereUniqueInputSchema,
}).strict() ;

export default ModeratorFindUniqueOrThrowArgsSchema;
