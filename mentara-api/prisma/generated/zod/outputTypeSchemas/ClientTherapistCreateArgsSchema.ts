...
export const ClientTherapistCreateArgsSchema: z.ZodType<Prisma.ClientTherapistCreateArgs> = z.object({
  select: ClientTherapistSelectSchema.optional(),
  include: z.lazy(() => ClientTherapistIncludeSchema).optional(),
  data: z.union([ ClientTherapistCreateInputSchema,ClientTherapistUncheckedCreateInputSchema ]),
}).strict() ;

export default ClientTherapistCreateArgsSchema;
