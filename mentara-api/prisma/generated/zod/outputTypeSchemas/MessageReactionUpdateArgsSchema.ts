...
export const MessageReactionUpdateArgsSchema: z.ZodType<Prisma.MessageReactionUpdateArgs> = z.object({
  select: MessageReactionSelectSchema.optional(),
  include: z.lazy(() => MessageReactionIncludeSchema).optional(),
  data: z.union([ MessageReactionUpdateInputSchema,MessageReactionUncheckedUpdateInputSchema ]),
  where: MessageReactionWhereUniqueInputSchema,
}).strict() ;

export default MessageReactionUpdateArgsSchema;
