...
export const TherapistFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.TherapistFindUniqueOrThrowArgs> = z.object({
  select: TherapistSelectSchema.optional(),
  include: z.lazy(() => TherapistIncludeSchema).optional(),
  where: TherapistWhereUniqueInputSchema,
}).strict() ;

export default TherapistFindUniqueOrThrowArgsSchema;
