...
export const ReplyFileFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.ReplyFileFindUniqueOrThrowArgs> = z.object({
  select: ReplyFileSelectSchema.optional(),
  include: z.lazy(() => ReplyFileIncludeSchema).optional(),
  where: ReplyFileWhereUniqueInputSchema,
}).strict() ;

export default ReplyFileFindUniqueOrThrowArgsSchema;
