...
export const TherapistSelectSchema: z.ZodType<Prisma.TherapistSelect> = z
  .object({
    ...
    processedByAdmin: z
      .union([z.boolean(), z.lazy(() => AdminArgsSchema)])
      .optional(),
    meetings: z
      .union([z.boolean(), z.lazy(() => MeetingFindManyArgsSchema)])
      .optional(),
    therapistAvailabilities: z
      .union([
        z.boolean(),
        z.lazy(() => TherapistAvailabilityFindManyArgsSchema),
      ])
      .optional(),
    worksheets: z
      .union([z.boolean(), z.lazy(() => WorksheetFindManyArgsSchema)])
      .optional(),
    assignedClients: z
      .union([z.boolean(), z.lazy(() => ClientTherapistFindManyArgsSchema)])
      .optional(),
    reviews: z
      .union([z.boolean(), z.lazy(() => ReviewFindManyArgsSchema)])
      .optional(),
    therapistFiles: z
      .union([z.boolean(), z.lazy(() => TherapistFilesFindManyArgsSchema)])
      .optional(),
    _count: z
      .union([z.boolean(), z.lazy(() => TherapistCountOutputTypeArgsSchema)])
      .optional(),
  })
  .strict();

export const TherapistUpdateArgsSchema: z.ZodType<Prisma.TherapistUpdateArgs> =
  z
    .object({
      ...
      data: z.union([
        ...
        TherapistUncheckedUpdateInputSchema,
      ]),
