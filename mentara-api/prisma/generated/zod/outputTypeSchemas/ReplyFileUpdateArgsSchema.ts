...
export const ReplyFileUpdateArgsSchema: z.ZodType<Prisma.ReplyFileUpdateArgs> = z.object({
  select: ReplyFileSelectSchema.optional(),
  include: z.lazy(() => ReplyFileIncludeSchema).optional(),
  data: z.union([ ReplyFileUpdateInputSchema,ReplyFileUncheckedUpdateInputSchema ]),
  where: ReplyFileWhereUniqueInputSchema,
}).strict() ;

export default ReplyFileUpdateArgsSchema;
