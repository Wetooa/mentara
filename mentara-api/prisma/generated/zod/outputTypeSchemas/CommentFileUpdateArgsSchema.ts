...
export const CommentFileUpdateArgsSchema: z.ZodType<Prisma.CommentFileUpdateArgs> = z.object({
  select: CommentFileSelectSchema.optional(),
  include: z.lazy(() => CommentFileIncludeSchema).optional(),
  data: z.union([ CommentFileUpdateInputSchema,CommentFileUncheckedUpdateInputSchema ]),
  where: CommentFileWhereUniqueInputSchema,
}).strict() ;

export default CommentFileUpdateArgsSchema;
