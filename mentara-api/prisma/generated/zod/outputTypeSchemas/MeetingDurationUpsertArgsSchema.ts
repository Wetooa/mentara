...
import { MeetingDurationCreateInputSchema } from '../inputTypeSchemas/MeetingDurationCreateInputSchema'
import { MeetingDurationUncheckedCreateInputSchema } from '../inputTypeSchemas/MeetingDurationUncheckedCreateInputSchema'
...
export const MeetingDurationUpsertArgsSchema: z.ZodType<Prisma.MeetingDurationUpsertArgs> = z.object({
  ...
  create: z.union([ MeetingDurationCreateInputSchema,MeetingDurationUncheckedCreateInputSchema ]),
  update: z.union([ MeetingDurationUpdateInputSchema,MeetingDurationUncheckedUpdateInputSchema ]),
}).strict() ;

export default MeetingDurationUpsertArgsSchema;
