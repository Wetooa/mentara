...
export const MeetingDurationCreateArgsSchema: z.ZodType<Prisma.MeetingDurationCreateArgs> = z.object({
  select: MeetingDurationSelectSchema.optional(),
  include: z.lazy(() => MeetingDurationIncludeSchema).optional(),
  data: z.union([ MeetingDurationCreateInputSchema,MeetingDurationUncheckedCreateInputSchema ]),
}).strict() ;

export default MeetingDurationCreateArgsSchema;
