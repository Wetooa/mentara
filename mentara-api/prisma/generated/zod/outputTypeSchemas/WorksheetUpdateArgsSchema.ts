...
export const WorksheetUpdateArgsSchema: z.ZodType<Prisma.WorksheetUpdateArgs> = z.object({
  select: WorksheetSelectSchema.optional(),
  include: z.lazy(() => WorksheetIncludeSchema).optional(),
  data: z.union([ WorksheetUpdateInputSchema,WorksheetUncheckedUpdateInputSchema ]),
  where: WorksheetWhereUniqueInputSchema,
}).strict() ;

export default WorksheetUpdateArgsSchema;
