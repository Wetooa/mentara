...
export const TherapistUncheckedCreateWithoutReviewsInputSchema: z.ZodType<Prisma.TherapistUncheckedCreateWithoutReviewsInput> = z.object({
  userId: z.string(),
  mobile: z.string(),
  province: z.string(),
...
export default TherapistUncheckedCreateWithoutReviewsInputSchema;
