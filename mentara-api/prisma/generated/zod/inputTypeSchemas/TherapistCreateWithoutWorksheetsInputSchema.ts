...
export const TherapistCreateWithoutWorksheetsInputSchema: z.ZodType<Prisma.TherapistCreateWithoutWorksheetsInput> = z.object({
  mobile: z.string(),
  province: z.string(),
...
export default TherapistCreateWithoutWorksheetsInputSchema;
