...
export const ReplyHeartUpdateWithoutUserInputSchema: z.ZodType<Prisma.ReplyHeartUpdateWithoutUserInput> = z.object({
  id: z.union([ z.string().uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  reply: z.lazy(() => ReplyUpdateOneRequiredWithoutHeartsNestedInputSchema).optional()
}).strict();

export default ReplyHeartUpdateWithoutUserInputSchema;
