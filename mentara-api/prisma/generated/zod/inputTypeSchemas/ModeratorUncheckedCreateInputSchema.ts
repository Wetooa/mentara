...
export const ModeratorUncheckedCreateInputSchema: z.ZodType<Prisma.ModeratorUncheckedCreateInput> = z.object({
  userId: z.string(),
...
export default ModeratorUncheckedCreateInputSchema;
