...
export const TherapistUncheckedCreateWithoutMeetingsInputSchema: z.ZodType<Prisma.TherapistUncheckedCreateWithoutMeetingsInput> = z.object({
  userId: z.string(),
...
export default TherapistUncheckedCreateWithoutMeetingsInputSchema;
