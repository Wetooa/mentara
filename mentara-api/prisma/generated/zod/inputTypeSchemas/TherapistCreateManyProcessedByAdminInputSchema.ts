...
export const TherapistCreateManyProcessedByAdminInputSchema: z.ZodType<Prisma.TherapistCreateManyProcessedByAdminInput> = z.object({
  userId: z.string(),
  mobile: z.string(),
  province: z.string(),
...
export default TherapistCreateManyProcessedByAdminInputSchema;
