...
export const TherapistCreateWithoutProcessedByAdminInputSchema: z.ZodType<Prisma.TherapistCreateWithoutProcessedByAdminInput> = z.object({
  mobile: z.string(),
  province: z.string(),
...
export default TherapistCreateWithoutProcessedByAdminInputSchema;
