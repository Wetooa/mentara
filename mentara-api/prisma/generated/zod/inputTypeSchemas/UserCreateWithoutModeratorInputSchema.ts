...
export const UserCreateWithoutModeratorInputSchema: z.ZodType<Prisma.UserCreateWithoutModeratorInput> = z.object({
  id: z.string(),
  email: z.string(),
  firstName: z.string(),
...
export default UserCreateWithoutModeratorInputSchema;
