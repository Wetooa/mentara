...
export const UserUncheckedCreateWithoutBlockingInputSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutBlockingInput> = z.object({
  id: z.string(),
  email: z.string(),
  firstName: z.string(),
...
export default UserUncheckedCreateWithoutBlockingInputSchema;
