...
export const UserUncheckedCreateWithoutMessageReactionsInputSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutMessageReactionsInput> = z.object({
  id: z.string(),
  email: z.string(),
  firstName: z.string(),
...
export default UserUncheckedCreateWithoutMessageReactionsInputSchema;
