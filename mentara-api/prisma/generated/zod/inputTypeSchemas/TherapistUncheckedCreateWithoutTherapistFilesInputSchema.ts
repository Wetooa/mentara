...
export const TherapistUncheckedCreateWithoutTherapistFilesInputSchema: z.ZodType<Prisma.TherapistUncheckedCreateWithoutTherapistFilesInput> = z.object({
  userId: z.string(),
  mobile: z.string(),
  province: z.string(),
...
export default TherapistUncheckedCreateWithoutTherapistFilesInputSchema;
