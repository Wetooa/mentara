...
export const UserCreateWithoutMessageReadReceiptsInputSchema: z.ZodType<Prisma.UserCreateWithoutMessageReadReceiptsInput> = z.object({
  id: z.string(),
  email: z.string(),
  firstName: z.string(),
...
export default UserCreateWithoutMessageReadReceiptsInputSchema;
