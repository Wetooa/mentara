...
export const MeetingUpdateInputSchema: z.ZodType<Prisma.MeetingUpdateInput> = z
  .object({
    id: z
      .union([
        z.string().uuid(),
    ...
    status: z
      .union([
        z.lazy(() => MeetingStatusSchema),
        z.lazy(() => EnumMeetingStatusFieldUpdateOperationsInputSchema),
      ])
      .optional(),
    meetingType: z
    ...
    updatedAt: z
      ...
      .optional(),
    client: z
      .lazy(() => ClientUpdateOneRequiredWithoutMeetingsNestedInputSchema)
      .optional(),
    therapist: z
      .lazy(() => TherapistUpdateOneRequiredWithoutMeetingsNestedInputSchema)
      .optional(),
    durationConfig: z
      .lazy(() => MeetingDurationUpdateOneWithoutMeetingsNestedInputSchema)
      .optional(),
  })
  .strict();

export default MeetingUpdateInputSchema;
