...
export const UserCreateWithoutCommentHeartsInputSchema: z.ZodType<Prisma.UserCreateWithoutCommentHeartsInput> = z.object({
  id: z.string(),
  email: z.string(),
  firstName: z.string(),
...
export default UserCreateWithoutCommentHeartsInputSchema;
