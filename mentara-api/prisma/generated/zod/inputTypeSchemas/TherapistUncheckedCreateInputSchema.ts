...
export const TherapistUncheckedCreateInputSchema: z.ZodType<Prisma.TherapistUncheckedCreateInput> = z.object({
  userId: z.string(),
...
export default TherapistUncheckedCreateInputSchema;
