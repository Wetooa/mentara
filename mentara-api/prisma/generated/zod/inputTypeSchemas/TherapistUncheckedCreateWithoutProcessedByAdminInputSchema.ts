...
export const TherapistUncheckedCreateWithoutProcessedByAdminInputSchema: z.ZodType<Prisma.TherapistUncheckedCreateWithoutProcessedByAdminInput> = z.object({
  userId: z.string(),
  mobile: z.string(),
  province: z.string(),
...
export default TherapistUncheckedCreateWithoutProcessedByAdminInputSchema;
