...
export const UserUncheckedCreateWithoutPostHeartsInputSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutPostHeartsInput> = z.object({
  id: z.string(),
  email: z.string(),
  firstName: z.string(),
...
export default UserUncheckedCreateWithoutPostHeartsInputSchema;
