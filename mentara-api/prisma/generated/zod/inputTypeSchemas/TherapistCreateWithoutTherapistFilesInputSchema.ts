...
export const TherapistCreateWithoutTherapistFilesInputSchema: z.ZodType<Prisma.TherapistCreateWithoutTherapistFilesInput> = z.object({
  mobile: z.string(),
  province: z.string(),
...
export default TherapistCreateWithoutTherapistFilesInputSchema;
