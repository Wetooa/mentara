...
export const UserCreateWithoutPostHeartsInputSchema: z.ZodType<Prisma.UserCreateWithoutPostHeartsInput> = z.object({
  id: z.string(),
  email: z.string(),
  firstName: z.string(),
...
export default UserCreateWithoutPostHeartsInputSchema;
