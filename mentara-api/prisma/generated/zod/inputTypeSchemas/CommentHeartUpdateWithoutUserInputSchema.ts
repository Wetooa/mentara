...
export const CommentHeartUpdateWithoutUserInputSchema: z.ZodType<Prisma.CommentHeartUpdateWithoutUserInput> = z.object({
  id: z.union([ z.string().uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  comment: z.lazy(() => CommentUpdateOneRequiredWithoutHeartsNestedInputSchema).optional()
}).strict();

export default CommentHeartUpdateWithoutUserInputSchema;
