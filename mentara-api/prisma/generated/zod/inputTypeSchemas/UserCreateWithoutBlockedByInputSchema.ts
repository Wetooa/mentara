...
export const UserCreateWithoutBlockedByInputSchema: z.ZodType<Prisma.UserCreateWithoutBlockedByInput> = z.object({
  id: z.string(),
  email: z.string(),
  firstName: z.string(),
...
export default UserCreateWithoutBlockedByInputSchema;
