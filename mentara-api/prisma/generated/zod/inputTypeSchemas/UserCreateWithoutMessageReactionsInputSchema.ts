...
export const UserCreateWithoutMessageReactionsInputSchema: z.ZodType<Prisma.UserCreateWithoutMessageReactionsInput> = z.object({
  id: z.string(),
  email: z.string(),
  firstName: z.string(),
...
export default UserCreateWithoutMessageReactionsInputSchema;
