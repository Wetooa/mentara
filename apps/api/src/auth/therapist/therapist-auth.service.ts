    ...
    const result = await this.prisma.$transaction(async (tx) => {
      ...
      const therapist = await tx.therapist.create({
        data: {
          ...
          isPRCLicensed: registerDto.isPRCLicensed,
          ...
          assessmentTools: registerDto.assessmentTools || [],
          ...
          professionalLiabilityInsurance: registerDto.professionalLiabilityInsurance,
