...
import { CurrentUserRole } from '../core/decorators/current-user-role.decorator';
import { ZodValidationPipe } from '../../../common/pipes/zod-validation.pipe';
// Import types from local auth types
import type { RegisterModeratorDto } from '../types';

// Import validation schemas from local validation
import { RegisterModeratorDtoSchema } from '../validation';
